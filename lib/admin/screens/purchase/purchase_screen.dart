...
class _PurchaseScreenState extends State<PurchaseScreen> {
        ...
        builder: (ctx, setModal) => Padding(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('PO: ${item.orderNumber}', style: TextStyle(fontSize: 13, color: Colors.grey[600])),
              const SizedBox(height: 20),
                ...
                Expanded(child: ElevatedButton(
                  onPressed: () async {
                    ...
                    final res = await DataService.addIncomingProductPayment(item.id, {
                      'amount': amount, 'payment_date': dateCtrl.text, 'payment_method': method,
                    });
                    if (!mounted) return;
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: Text(res.success ? 'Pembayaran tersimpan' : (res.message.isNotEmpty ? res.message : 'Gagal')),
                      backgroundColor: res.success ? Colors.green : Colors.red,
                    ));
                    if (res.success) _loadPage(_currentPage);
                  },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Pembelian', style: TextStyle(fontWeight: FontWeight.w800)),
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Padding(
                              ...
                              child: Row(children: [
                                ...
                                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Text(item.orderNumber, style: const TextStyle(
                            ...
                            Padding(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                Text('Total Pembelian', style: TextStyle(fontSize: 12, color: Colors.grey[500])),
                                Text(_currency.format(item.totalPrice),
                                  style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w900, color: _blue)),
                              ]),
                            ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.push(context, MaterialPageRoute(
          ...
          .then((ok) { if (ok == true) _loadPage(1); }),
